...
const plans = [
  ...
  },
  {
    name: "Agency",
    monthlyPrice: 199,
    features: ["Unlimited sites", "All Web3 blocks", "White-label", "Custom domain", "API access"],
    cta: "Contact Sales",
    featured: false,
    contactSales: true,
  },
      ...
      <main className="container max-w-5xl mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Select a plan to access your dashboard and start building.
          </p>
          ...
          <div className="inline-flex items-center gap-3 glass rounded-full px-2 py-1.5">
            <button
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-medium transition-all ${
                !isAnnual ? "gradient-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground"
              }`}
            >
              Monthly
            </button>
            ...
            return (
              <motion.div
                ...
                className={`rounded-lg p-6 flex flex-col ${
                  plan.featured ? "glass glow-primary border border-primary/30" : "glass"
                }`}
              >
                {plan.featured && (
                ...
                <p className="text-sm text-muted-foreground mb-6 mt-1">
                  {plan.contactSales ? "For agencies and studios at scale." : "14-day free trial included."}
                </p>
